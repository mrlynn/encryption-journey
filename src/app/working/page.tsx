export default function WorkingPage() {
  return (
    <div className="min-h-screen bg-mongo-dark-900 p-8">
      <h1 className="text-3xl font-bold text-primary mb-6">Working Test Page</h1>
      
      <div className="bg-mongo-dark-800 p-6 rounded-lg">
        <h2 className="text-xl font-semibold text-neutral-200 mb-4">This page works!</h2>
        ...
        <div className="mt-6 p-4 bg-accent/20 rounded-lg border border-accent/30">
          <p className="text-neutral-300 text-sm">
            <strong>Next step:</strong> The issue is with client-side JavaScript execution. 
            The useEffect hooks are not running, which suggests a React hydration problem.
          </p>
        </div>
      </div>
    </div>
