...
export default function TestButtonPage() {
  ...
  return (
    <div className="min-h-screen bg-mongo-dark-900 p-8">
      <h1 className="text-3xl font-bold text-primary mb-6">Button Test Page</h1>
      
      <div className="bg-mongo-dark-800 p-6 rounded-lg">
        <h2 className="text-xl font-semibold text-neutral-200 mb-4">Button Test</h2>
        ...
        <div className="space-y-4">
          <div className="bg-mongo-dark-700 p-4 rounded">
            <h3 className="text-lg font-semibold text-primary mb-2">Click Test</h3>
            <button
              onClick={handleClick}
